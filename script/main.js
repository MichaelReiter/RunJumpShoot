...
AudioManager = (function() {
  function AudioManager() {
    ...
    this.playMusic();
    game.time.events.loop(Phaser.Timer.SECOND * 12.387, this.playMusic, this);
  }
