LevelSelectState =
  ...
  create: ->
    ...
    @levelOne = new Phaser.Button(game, GameResolution.width*0.2, GameResolution.height*0.5, 'button_square', @levelSelected, this, 0, 0, 1, 0)
    ...
    @levelTwo = new Phaser.Button(game, GameResolution.width*0.6, GameResolution.height*0.5, 'button_square', @levelSelected, this, 0, 0, 1, 0)
    ...
    @levelThree = new Phaser.Button(game, GameResolution.width*0.2, GameResolution.height*0.75, 'button_square', @levelSelected, this, 0, 0, 1, 0)
    ...
    @levelFour = new Phaser.Button(game, GameResolution.width*0.6, GameResolution.height*0.75, 'button_square', @levelSelected, this, 0, 0, 1, 0)
